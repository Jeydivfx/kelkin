...
class MovieGridAdapter(private val onMovieClick: (Movie) -> Unit) :
    ...
    class MovieViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(movie: Movie) {
            ...
            Log.d("SearchTest", "PosterRawPath: ${movie.posterUrl}")
            ...
            Log.d("SearchTest", "نام فیلم: ${movie.name_fa} | لینک پوستر: ${movie.posterUrl}")


            if (fullUrl != null) {
                Log.d("SearchTest", "Loading Image: $fullUrl")
            }
